...
SECRET_KEY = 'django-insecure-bmg^kb_yjj7r6v8wabos7g(1b!6!v=n1^c-a1r7z6r%(rxidtx'
...
INSTALLED_APPS = [
    ...
    'event_planner.accounts.apps.AccountsConfig',
    'event_planner.events.apps.EventsConfig',
